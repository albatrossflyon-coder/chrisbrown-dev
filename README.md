...
Personal developer portfolio: a scroll-driven showcase of 6 real projects, built with **Next.js**, **React Three Fiber**, and **GSAP ScrollTrigger**.
...
The site is a scroll-driven tour through 6 real projects:
...
- **rag-system**: self-evaluating RAG engine with hybrid + graph-boosted retrieval
- **agentic-rust-mcp**: production Rust MCP server integrating Render, Vercel, Buffer, and Firestore
- **NFT Marketplace**: responsive marketplace build, Frontend Simplified internship
- **Summarist**: Blinkist-style book app with real Firebase auth and Stripe subscriptions
